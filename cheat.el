  ...
  (defun cheat-diff (name version)
    "Show the diff between the given version and the current version of the
    named cheat.
  ...
  (defun cheat-add-current-buffer (name)
    "Add a new cheat with the specified name and the current buffer as the
    body."
  ...
  (defun cheat-save-current-buffer ()
    "Save the current buffer using the buffer name for the title and the
  ...
  The name of the sheet read is stored in *cheat-last-sheet* unless it was
  blank."
